...
## Paths for Mac Pro
#conn_path='/Volumes/MacintoshHD3/Hans/Positivity_Project/Positivity_fMRI_Analysis/Flexibility_fMRI_Analysis/Connectivity'
#beta_path='/Volumes/MacintoshHD3/Hans/Positivity_Project/Positivity_fMRI_Analysis/Flexibility_fMRI_Analysis/Single_Beta_analysis/concatenated'

# Paths for Hans' Macbook Pro
conn_path='/Volumes/My_Passport/Positivity_Project/Positivity_fMRI_Analysis/Flexibility_fMRI_Analysis/Connectivity'
beta_path='/Volumes/My_Passport/Positivity_Project/Positivity_fMRI_Analysis/Flexibility_fMRI_Analysis/Single_Beta_analysis/concatenated'
...
# input subjects betas ts
fslmeants -i $beta_path/cdn_${SubNo}.nii -m $conn_path/$SubNo/WM_CSFconfounds/${SubNo}_standard_WM_mask90_bin -o $conn_path/$SubNo/WM_CSFconfounds/${SubNo}_WM_confound_meants.txt

fslmeants -i $beta_path/cdn_${SubNo}.nii -m $conn_path/$SubNo/WM_CSFconfounds/${SubNo}_standard_CSF_mask90_bin -o $conn_path/$SubNo/WM_CSFconfounds/${SubNo}_CSF_confound_meants.txt
...
#for SubNo in $subs; do echo $SubNo; cat "$conn_path/$SubNo/WM_CSFconfounds/${SubNo}_WM_confound_meants.txt" >> all_cdn_WM_confound_meants.txt; cat "$conn_path/$SubNo/WM_CSFconfounds/${SubNo}_CSF_confound_meants.txt" >> all_cdn_CSF_confound_meants.txt	;done
