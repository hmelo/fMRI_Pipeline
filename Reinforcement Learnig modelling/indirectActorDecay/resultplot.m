...
%           parameters : other parameters from indirectActor function
...
[negLogLike, td, exploitation, probs, m] = indirectActor2Indv(exploration, reward, choice, numChoice, parameters);
