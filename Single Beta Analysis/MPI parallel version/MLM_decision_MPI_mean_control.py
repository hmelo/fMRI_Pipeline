...
R_model = "exploit ~ (fMRI_data + fMRI_t_1 + fMRI_t_2) + fMRI_meanIs + CSF_cov + WM_cov +(1|subject)"
...
wmFile = '/Users/home/Google Drive/Positivity Project/Exploration_fMRI_Analysis/Single_Beta_Analysis/explore_WM_cov.txt' # WM_cov file
csfFile = '/Users/home/Google Drive/Positivity Project/Exploration_fMRI_Analysis/Single_Beta_Analysis/explore_CSF_cov.txt' # CSF_cov file
...
wm = numpy.genfromtxt(wmFile, delimiter=",")
csf = numpy.genfromtxt(csfFile, delimiter=",")
WM_cov=FloatVector(wm)
CSF_cov=FloatVector(csf)
...
first_trial = numpy.arange(meanImages.shape[3])*149 # the first trial for every participant is nan, since no previous trial could predict it
fMRI_t_1 = numpy.arange(10579.0) # create array of same length fMRI_data
fMRI_t_1[1:] = fMRI_data[:10578] # move fmri(t-1) values into fMRI_t_1
...
second_trial = numpy.arange(meanImages.shape[3])*150 # the second trial for every participant is nan, since no previous trial could predict it
second_trial[0]=1 #second trial of first subject                    
fMRI_t_2 = numpy.arange(10579.0) # create array of same length fMRI_data
fMRI_t_2[2:] = fMRI_data[:10577] # move fmri(t-1) values into fMRI_t_1
fMRI_t_2[first_trial]=numpy.nan # move nan's for first trial
fMRI_t_2[second_trial]=numpy.nan # move nan's for second trial
